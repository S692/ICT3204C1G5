...
RUN wget https://raw.githubusercontent.com/S692/ICT3204C1G5/shah/metricbeat/metricbeat.yml -O /etc/metricbeat/metricbeat.yml
RUN metricbeat modules enable elasticsearch-xpack

# # Run Metricbeat
# RUN wget https://raw.githubusercontent.com/S692/ICT3204C1G5/shah/trigger.sh
